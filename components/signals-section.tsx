...
const signals = [
  {
    date: "2025.06.10",
    title: "EC Chamber",
    note: "Aluminium disc electrodes spanning the full cylinder cross-section. Al³⁺ ions form floc that binds suspended solids and pathogens.",
  },
  {
    date: "2025.05.28",
    title: "Timed Gate",
    note: "Servo-controlled disc holds water for 15 minutes of EC contact time. Releases only when the timer fires.",
  },
  {
    date: "2025.05.15",
    title: "Sensor Pod",
    note: "Unified housing measures pH, turbidity ×2, and TDS simultaneously. Readings every 3.5 seconds.",
  },
  {
    date: "2025.04.30",
    title: "WQI Scoring",
    note: "Stage-aware weighting of sensor data into a 0–100 quality index. Post-lamella: turbidity weighted 50%.",
  },
  {
    date: "2025.04.12",
    title: "AI Routing",
    note: "Six intelligence layers — flatline detection, confidence analysis, cycle fingerprinting — route water to Tank A or B.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / System</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">THE PIPELINE</h2>
      </div>
      <div
...
function SignalCard({ signal, index }: { signal: { date: string; title: string; note: string }; index: number }) {
  return (
    <article className={cn("group relative flex-shrink-0 w-80", "transition-transform duration-500 ease-out", "hover:-translate-y-2")}>
